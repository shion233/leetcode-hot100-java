...
| 动态规划 / Dynamic Programming | 32. 最长有效括号；70. 爬楼梯；118. 杨辉三角；139. 单词拆分；152. 乘积最大子数组；198. 打家劫舍；279. 完全平方数；300. 最长递增子序列；322. 零钱兑换；416. 分割等和子集 |
| 多维动态规划 / Multidimensional DP | 5. 最长回文子串；62. 不同路径；64. 最小路径和；72. 编辑距离；1143. 最长公共子序列 |
| 技巧 / Techniques | 75. 颜色分类；136. 只出现一次的数字；169. 多数元素 |
